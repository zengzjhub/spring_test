	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="http://localhost:8080/itheima_spring_test_war_exploded/user/findAll.do">用户管理</a></li>
		...
		<script type="text/javascript" src="../plugins/daterangepicker/daterangepicker.zh-CN.js"></script>
		...
		<script type="text/javascript" src="../plugins/adminLTE/js/app.min.js"></script>
		<script type="text/javascript" src="../plugins/treeTable/jquery.treetable.js"></script>
		...
		<script type="text/javascript" src="../plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.zh-CN.js"></script>
		<script type="text/javascript" src="../plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>
		<script type="text/javascript" src="../plugins/bootstrap-markdown/locale/bootstrap-markdown.zh.js"></script>
